...
import {
    ...
    HTML5_VALUE_MAP,
} from 'vscode-html-languageservice/lib/umd/languageFacts/data/html5';
...
const svelteEvents = [
    ...HTML5_EVENTS.map(mapToSvelteEvent),
    {
        name: 'on:introstart',
...
const html5Tags = HTML5_TAGS.map(tag => {
...
export const svelteHtmlDataProvider = newHTMLDataProvider('svelte-builtin', {
    version: 1,
    globalAttributes: [...HTML5_GLOBAL_ATTRIBUTES, ...svelteEvents, ...svelteAttributes],
