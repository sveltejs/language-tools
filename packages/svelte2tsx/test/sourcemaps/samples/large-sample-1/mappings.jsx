...
------------------------------------------------------------------------------------------------------------------------------------------------------ */}
                ...
                relaxed                                                                                                                               {/**
------------------------------------------------------------------------------------------------------------------------------------------------------ */}
            />{/*Ωignore_startΩ*/new Repl({target: __sveltets_any(''), props: {workersUrl:"workers", svelteUrl:svelteUrl, rollupUrl:rollupUrl, orientation:mobile ? 'columns' : 'rows', fixed:mobile, injectedJS:mapbox_setup, relaxed:true}})/*Ωignore_endΩ*/.$on('change', handle_change)}{/**
         ╚╚╚/>{/*Ωignore_startΩ*/new•Repl({target:•__sveltets_any(''),•props:•{workersUrl:"workers",•svelteUrl:svelteUrl,•rollupUrl:rollupUrl,•orientation:mobile•?•'columns'•:•'rows',•fixed:mobile,•injectedJS:mapbox_setup,•relaxed:true}})/*Ωignore_endΩ*/.$on('change',•handle_change)}↲    [generated] line 172
         ...
         ╚╚╚/>{/*Ωignore_startΩ*/new•Repl({target:•__sveltets_any(''),•props:•{workersUrl:"workers",•svelteUrl:svelteUrl,•rollupUrl:rollupUrl,•orientation:mobile•?•'columns'•:•'rows',•fixed:mobile,•injectedJS:mapbox_setup,•relaxed:true}})/*Ωignore_endΩ*/.$on('change',•handle_change)}↲    [generated] line 172
         ╚╚╚/>{/*Ωignore_startΩ*/new•Repl({target:•__sveltets_any(''),•props:•{workersUrl:"workers",•svelteUrl:svelteUrl,•rollupUrl:rollupUrl,•orientation:mobile•?•'columns'•:•'rows',•fixed:mobile,•injectedJS:mapbox_setup,•relaxed:true}})/*Ωignore_endΩ*/.$                            ↲    [generated] subset
         ╚╚╚/>                                                                                                                                                                                                                                                                              ↲    
         ╚╚╚/>↲                                                                                                                                                                                                                                                                                  [original] line 312 
------------------------------------------------------------------------------------------------------------------------------------------------------ */}
        </div>
