...
return { props: /** @type {Record<string, never>} */ ({}), slots: {}, events: {'click':__sveltets_2_unionType(__sveltets_2_bubbleEventDef(__sveltets_2_instanceOf(Button).$$events_def, 'click'),__sveltets_2_bubbleEventDef(__sveltets_2_instanceOf(Radio).$$events_def, 'click'))} }}
